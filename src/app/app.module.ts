...
@NgModule({
  declarations: [AppComponent, MenuComponent, SearchPageComponent, SavedPageComponent, SearchPageItemComponent, SearchPageItemDetailesComponent, SavedPageItemComponent, SavedPageItemDetailsComponent],
